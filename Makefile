...
OFILES = main.o myLib.o font.o ship_image.o GalagaTitleScreen.o GameOverScreen.o AlienTypeA.o AlienTypeB.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h ship_image.h GalagaTitleScreen.h GameOverScreen.h AlienTypeA.h AlienTypeB.h
